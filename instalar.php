...
$uid = db_agregar_datos("ventas_categorias", array("padre" => NULL, "nombre" => "Inmuebles", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Campo", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Alquiler de apartamentos", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Alquiler de apartamentos amueblados", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Alquiler de casas", "descripcion" => "", "rubro" => "articulo"));
$uid = db_agregar_datos("ventas_categorias", array("padre" => NULL, "nombre" => "Automotores", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Autos Sedan", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Vehiculos Utilitarios", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Camionetas", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Camiones", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Autos antiguos", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Motos", "descripcion" => "", "rubro" => "articulo"));
    db_agregar_datos("ventas_categorias", array("padre" => $uid, "nombre" => "Nautica", "descripcion" => "", "rubro" => "articulo"));

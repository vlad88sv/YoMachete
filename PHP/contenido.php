...
function CONTENIDO_PUBLICACION($op="")
{
    ...
    echo "<b>Vendedor:</b> " . ui_href("","perfil?id=".$Vendedor['id_usuario'],$Vendedor['usuario']) . " / <b>e-mail de contacto:</b> ". '<img src="imagen_c_'.$Vendedor['id_usuario'].'" />'. ( _F_usuario_cache('id_usuario') != $Vendedor['id_usuario'] ? " / enviar un <b>". ui_href("","mp?id=".$Vendedor['id_usuario'],"Mensaje Privado")."</b> " : " ")."<span  class=\"auto_mostrar\">[<a id=\"ver_mas_vendedor\">ver datos sobre el vendedor...</a>]</span>";
